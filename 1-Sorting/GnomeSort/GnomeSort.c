...
int main() {
    ...
    gnomeSort(test_small, small_size);
    ...
    double time_medium = measure_time(test_medium, medium_size, gnomeSort);
    ...
    double time_large = measure_time(test_large, large_size, gnomeSort);
